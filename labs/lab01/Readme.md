...
- #### Выполним команду "arp -a" в командной строке компьютера PC-B. До осуществления эхо-запросов никаких соответствий IP-адресов MAC-адресам устройств в сети протокол ARP не выявил для PC-B не выявил.
